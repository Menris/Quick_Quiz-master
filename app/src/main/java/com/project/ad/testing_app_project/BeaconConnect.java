    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                findViewById(R.id.activity_beacon_connect).setBackgroundColor((int) valueAnimator.getAnimatedValue());
            }
        });
        colorAnimation.setRepeatCount(Animation.INFINITE);
        colorAnimation.start();

        tv_progress = (TextView) findViewById(R.id.textView_BeaconProgress);
        ...
        beaconManager.setRangingListener(new BeaconManager.RangingListener() {
            ...
            public void onBeaconsDiscovered(com.estimote.sdk.Region region, List<Beacon> list) {
                if (!list.isEmpty()) {
                    ...
                    tv_progress.setText(String.valueOf(computeProximity(nearestBeacon)));
